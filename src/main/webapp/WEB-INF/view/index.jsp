    ...
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between">
      <div class="col-md-3 mb-2 mb-md-0">
        <a href="/" class="d-inline-flex link-body-emphasis text-decoration-none">
          <svg width="102" height="32" style="display:inline-block; color: #ff385c;">
      ...
      <div class = "search">
        <div class="btn-group" role="group" style="margin: 10px">
          <button type="button" class="btn px-10 btn-sm">어디든지</button>
          <div class="vr"></div>
          <button type="button" class="btn px-10 btn-sm">언제든지 일주일</button>
          <div class="vr"></div>
          <button type="button" class="btn link-secondary btn-sm">게스트 추가</button>
        </div>
        <button type="button" class="btn" style="width: 34px; height: 34px; background-color: #ff385c; border-radius: 30px; color: white">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style="display:block;fill:none;height:12px;width:12px;stroke:currentColor;stroke-width:5.333333333333333;overflow:visible; margin-right: 9px" aria-hidden="true" role="presentation" focusable="false">
      ...
      <div class="text-end">
        <button type="button" class="btn" onclick="location.href='add'">당신의 공간을 에어비앤비하세요</button>
        <button type="button" class="btn">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 16px; width: 16px; fill: currentcolor; color: black">
        ...
        <button type="button" class="btn" style="width: 50px">
          <div class="row align-items-center justify-content-start">
            <div class="col-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; fill: none; height: 18px; width: 18px; stroke: currentcolor; stroke-width: 4; overflow: visible; color:gray">
                <g fill="none">
            ...
            <div class="col-3">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" aria-hidden="true" role="presentation" focusable="false" style="display: block; height: 25px; width: 25px; fill: currentcolor; color:gray;">
...
<main>
  <section id="middleroom"class="middle">
    <div class="image-grid">
      <c:forEach items="${list}" var ="u">
        <div class="home">
          <div class = "home__box">
            <img  src="https://a0.muscache.com/im/pictures/prohost-api/Hosting-574843000111312410/original/669ab99f-afdd-4b8a-87c6-aa6f6b46a5d9.jpeg?im_w=720" data-original-uri="https://a0.muscache.com/im/pictures/prohost-api/Hosting-574843000111312410/original/669ab99f-afdd-4b8a-87c6-aa6f6b46a5d9.jpeg?im_w=720" >
          </div>
          <div class = "home__info">
            <div class = "info1">${u.getAddress()}</div>
            <div class = "info2">${u.getLocation()}</div>
            <div class = "info3">${u.getHoliday()}</div>
            <div class = "info4">₩${u.getPrice()} / 박</div>
          </div>
          <button type="button" class="btn" onclick="location.href='edit/${u.getSeq()}'">수정</button>
          <button type="button" class="btn" onclick="delete_ok(${u.getSeq()});">삭제</button>
        </div>
      </c:forEach>
  <div class = "home">
    <div class = "home__box">
    ...
    <div class = "home__info">
      <div class = "info1">Dolsan-eup,Yeosu-si,한국</div>
      <div class = "info2">326km 거리</div>
      <div class = "info3">9월 3일~9일</div>
      <div class = "info4">₩159,000 / 박</div>
    </div>
  </div>

  <div class = "home">
    <div class = "home__box">
      <img src="https://a0.muscache.com/im/pictures/miso/Hosting-706856413814921022/original/0f516c0a-18fc-4d49-b997-112bd1ea2a41.jpeg?im_w=720" data-original-uri="https://a0.muscache.com/im/pictures/miso/Hosting-706856413814921022/original/0f516c0a-18fc-4d49-b997-112bd1ea2a41.jpeg?im_w=720">
    </div>
    <div class = "home__info">
      <div class = "info1">Oedong-eup, Gyeongju,한국</div>
      <div class = "info2">288km 거리</div>
      <div class = "info3">11월 1일~6일</div>
      <div class = "info4">₩696,118 / 박</div>
    </div>
  </div>

  <div class = "home">
    <div class = "home__box">
      <img src="https://a0.muscache.com/im/pictures/miso/Hosting-44283479/original/5aac0c63-5ce6-4ef9-a172-62c0ff73d367.jpeg?im_w=720" data-original-uri="https://a0.muscache.com/im/pictures/miso/Hosting-44283479/original/5aac0c63-5ce6-4ef9-a172-62c0ff73d367.jpeg?im_w=720">
    </div>
    <div class = "home__info">
      <div class = "info1">Seo-myeon,Hongcheon,한국</div>
      <div class = "info2">64km 거리</div>
      <div class = "info3">8월 1일~6일</div>
      <div class = "info4">₩300,000 / 박</div>
    </div>
  </div>

  <div class = "home">
    <div class = "home__box">
      <img src="https://a0.muscache.com/im/pictures/miso/Hosting-631554907583106545/original/6112a585-4876-4c97-af7f-7cbcb0b6738d.jpeg?im_w=720" data-original-uri="https://a0.muscache.com/im/pictures/miso/Hosting-631554907583106545/original/6112a585-4876-4c97-af7f-7cbcb0b6738d.jpeg?im_w=720">
    </div>
    <div class = "home__info">
      <div class = "info1">상면,가평군,한국</div>
      <div class = "info2">38km 거리</div>
      <div class = "info3">8월 2일~7일</div>
      <div class = "info4">₩300,000 / 박</div>
    </div>
  </div>
  </section>
  ...
  <div id="map-container" style="display:none;">
    <div id="map" style="width:100%; height: 100vh; position: absolute; z-index: 1;"></div>
  </div>

  <button id="map-button" type="button" class="btn btn-dark" onclick="showMap()" style="position: fixed; top: 80%; left: 48%; z-index: 2; border-radius: 20px;">지도 표시하기 </button>

  <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA2UTMgsrozCnGLbsjHgcgINoyAzYMAU-A&callback=initMap&region=kr"></script>
  <script src="../js/script.js"></script>
  <script>
    var mapIsShown = false; // 지도가 보여졌는지 여부를 저장하는 변수

    function showMap() {
      if (mapIsShown) {    // 이미 지도가 보여지고 있는 경우
        // 지도 컨테이너를 숨깁니다.
        document.getElementById("map-container").style.display = "none";
        document.getElementById("middleroom").style.display = "block";
        document.getElementById("map-button").innerHTML = "지도 표시하기";
        mapIsShown = false; // 지도가 숨겨졌음을 저장합니다.
      } else {             // 아직 지도가 보여지지 않은 경우
        // 지도 컨테이너를 표시합니다.
        document.getElementById("map-container").style.display = "block";
        document.getElementById("middleroom").style.display = "none";
        document.getElementById("map-button").innerHTML = "목록보기";
        // 지도를 생성합니다.
        initMap();
        mapIsShown = true;  // 지도가 보여졌음을 저장합니다.
      }
    }
  </script>
...
<footer>
  <div class="site__rule">
    <div class="rule">
      <span dir="ltr">© 2023 Airbnb, Inc.</span>
      <ul class="nav justify-content-center">
        <li>·</li>
        <li><a href="https://www.airbnb.co.kr/help/article/2855">개인정보 처리방침</a></li>
        <li>·</li>
        <li><a href="https://www.airbnb.co.kr/help/article/2908">이용약관</a></li>
        <li>·</li>
        <li><a href="https://www.airbnb.co.kr/">사이트맵</a></li>
        <li>·</li>
        <li><a target="_blank" href="https://www.airbnb.co.kr/home/updated_cancellation_policies?korean_strict_policy=true#strict">한국의 변경된 환불 정책</a></li>
        <li>·</li>
        <li><a target="_blank" href="https://www.airbnb.co.kr/about/company-details">회사 세부정보</a></li>
      </ul>
    </div>
    <div class="money">
      ...
      <button type="button" class="btn btn-sm" >₩ KRW
      </button>
      <button type="button" class="btn btn-sm" >
        <div class="row align-items-center justify-content-center"> 지원 및 참고 자료
          <div class="col-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chevron-compact-up" viewBox="0 0 16 16" style="stroke: currentcolor;stroke-width: 2px; ">
  ...
  <hr style = "height: 1px; margin: 0 80px 0 80px; background-color: gray; border: none;">
  <div class="web__site" >
    웹사이트 제공자: Airbnb Ireland UC, private unlimited company, 8 Hanover Quay Dublin 2,D02 DP23 Ireland | 이사: Dermot Clarke, Killian Pattwell, Andrea Finnegan | VAT 번호:IE9827384L | 사업자 등록 번호: IE 511825 | 연락처: terms@airbnb.com, 웹사이트,080-822-0230 | 호스팅 서비스 제공업체: 아마존 웹서비스 | 에어비앤비는 통신판매 중개자로에어비앤비 플랫폼을 통하여 게스트와 호스트 사이에 이루어지는 통신판매의 당사자가 아닙니다.에어비앤비 플랫폼을 통하여 예약된 숙소, 체험, 호스트 서비스에 관한 의무와 책임은 해당서비스를 제공하는 호스트에게 있습니다.
  </div>
</footer>
